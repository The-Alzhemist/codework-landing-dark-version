    ...
    <section className="relative py-12 md:py-[100px] mx-auto px-5 lg:px-[50px]  bg-neutralVariant-1000 ">
      <div ref={ref} className=" m-auto max-w-[1440px]">
        ...
        <div className="flex flex-wrap justify-center gap-5 max-w-[1000px] m-auto ">
            <div className="bg-neutral-950-750 w-full rounded-2xl  border-[#59ADA0]   border-2 overflow-hidden">
              {/* img */}
               <div className="flex justify-center w-full h-[300px]  rounded-t-xl overflow-hidden mt-10  px-5 ">
               <img
                    src="https://fakeimg.pl/944x300/"
                    alt=""
               ...
               {/* text */}
               <div className=" text-slate-400 p-7 border-t-2  border-dashed text  border-[#59ADA0]">
                <h2 className=" text-[#59ADA0] text-4xl font-semibold">Seamoor marine</h2>

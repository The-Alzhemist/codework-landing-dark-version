...
const FormPage = ({
  ...
  return (
    <>
      <div className="relative bg-neutral-1000 rounded-xl w-full max-w-[1140px] mx-auto py-[30px] md:py-[50px] lg:px-[50px]  sm:my-0">
        ...
        <form
          className=" max-w-[1440px] px-5 md:px-5"
